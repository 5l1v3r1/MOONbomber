...
def showinfo():
	...
	logs.insert('insert','\nINFO>' + (all_info))
	secstartat = 0
	for secstartat in range(5):
		time.sleep(1)
		secstartat=secstartat+1
		logs.insert('insert','\nThe attack will begin in' + str(secstartat) +  'second')
...
Text3 = Label(text = 'Show info?', 
	font = ("Segoe Script", "11"),
	bg = '#1c0f1a',
	fg = '#37e827') 


Text2 = Label(text = 'Method', 
	font = ("Segoe Script", "11"),
	bg = '#1c0f1a',
	fg = '#37e827')
...
methodOnlyCall = Radiobutton(text="Only Call",
	variable = var,
	 value=0,
	 bg = '#141414',
	 font = 2,
...
methodCallAndMessage = Radiobutton(text="All",
	variable = var,
	 value=1,
	 bg = '#141414',
	 font = 2,
...
methodOnlyMessage = Radiobutton(text="Only Message",
	variable = var,
	 value=2,
	 bg = '#141414',
	 font = 2,
...
logs.pack()
logs.place(x = 0, y = 200)
Text2.pack()
Text2.place(x = 430, y = 40 )
methodOnlyCall.pack()
methodOnlyCall.place(x = 430, y = 60)
methodCallAndMessage.pack()
methodCallAndMessage.place(x = 430, y = 100)
methodOnlyMessage.pack()
methodOnlyMessage.place(x = 430, y = 140)
Text3.pack()
Text3.place(x = 430, y = 180)
yesshow.pack()
yesshow.place(x = 430, y = 230)
noshow.pack()
noshow.place(x = 430, y = 200)
